...
public class BedOverlay implements HudElement {
    public static final Identifier ID = Identifier.of(DungeonsBedwars.MOD_ID, "bed_overlay");
    ...
    public void render(DrawContext context, RenderTickCounter tickCounter) {
        ...
        // Shadow
        context.drawGuiTexture(RenderPipelines.GUI_TEXTURED, bed, bedX + shadowOffset, bedY + shadowOffset, bWidth, bHeight, shadowColor.getRGB());
        context.drawGuiTexture(RenderPipelines.GUI_TEXTURED, text, textX + shadowOffset, textY + shadowOffset, tWidth, tHeight, shadowColor.getRGB());

        // Main
        context.drawGuiTexture(RenderPipelines.GUI_TEXTURED, bed, bedX, bedY, bWidth, bHeight, mainColor.getRGB());
        context.drawGuiTexture(RenderPipelines.GUI_TEXTURED, text, textX, textY, tWidth, tHeight, mainColor.getRGB());
